...
gPats = [
  ...
  [  "%1 .. Is that the real reason?",
    "What other reasons come to mind other than because %1?",
    "seems logical yeah.. %1",
     "You know.. you're making me feel very uncomfortable..by saying %1 ",
    "I once had such ideas too.. until the lobotomy...",
    "And that is your final conclusion is it? %1?",
    "I shall pray for you",
    "Because of that? really?",
    "makes sense yeah but.. still.. seriously?",
    "Because the world is round.. it turns me on... *singing*",
    "Because the sky is blue.. it makes me cry... *singing*",
    "Because the world is round.. it blows my mind... *singing* ever heard the song because by the beatles?",
    "Does that reason apply to anything else? because %1 doesnt cut it",
    "Does that make sense to you? Because %1 ? does not make sense to me man..",
    "%1, so?"]],
  [r'(.*)Because(.*)',
