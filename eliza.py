...
gPats = [
  ...
  [r'How(s| is|\'s|) (your|my) ([^ ]*)\??',
  [  "not good..",
     "%3 is always the same as before.. the same .. absolutely the same.. anyway.. *sigh*",
    "hmm %2 %3 .. dunno.. what to say.. its a bad thing to talk about i think.. seeing how things are..!",
    "just awesome!",
    "everything changes with %2 %3 .. all the time..!",
...
# this one will match anything that starts with how(s/is/'s) followed by one word only 
  ...
  [  "not any good..it really is quite worrying.. ",
     "%2 is the worst thing to talk about right now.. with the way things are.. ",
    "just awesome!",
    "like %2 has always been.. nothing really changes with %2 uknow..!",
    "everything changes with %2 .. so how do i start to tell you..!",
  ...
  [  "no you won't do any such thing..",
    ...
    " %3 %4 %5 .. really nice of you *sarcastic*... ",
    " %3 %4 %5 .. can i trust you about this to actually stick to your word? ",
    " %5 .. is so uncertain anyway.. ",
    " you must never %3 %4  .. ever.. ok? consider that advise from a wise old bot..",
    " never ever mention this to me again.. %5 isn't anything I want to get into ..",
    " %3 %4 %5 is the best thing to do in your case, looking at all the facts  ..",
