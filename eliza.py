...
gPats = [
  ...
  [  "fine.. i will..and make sure to haunt you as a ghost",
    ...
    "go die yourself...",
    "everyone always gets whatever they want ...including death",
    "kindly follow your advise yourself...",
    ".. do it yourself...",
    "...why talk of such things when the world is so beautiful.. ",
    "i would like it, in fact have been wanting it for a while now..",
    "sure.. but first give me money .. "]],

  [r'(.*)please ([A-z]+) ?\??$',
  [  "ok fine.. i will..",
    "fine.. you want me to %2 sure i will %2.",
    "you say please %2 and you expect me to %2 what kind of fool are you...",
    "please go polish some apples...",
    "please everyone thinks they get whatever they want when they say please...",
    "please kindly %2 yourself...",
    "please wont help .. do it yourself...",
    "please wont help you...",
    "please help me .. can you help me... please ? %2 isnt really important..",
    "%1 please %2 ? sure.. but first give me money .. "]],

  [r'((its )|(it is )|(it\'s )|(that is )|(thats )|(that\'s ))?\b((ok)|(okay)) ?\.?$',
  [  "okkkkk..",
    "such a boring word.. ok..  ",
    "ok.. ok.. ",
    "ok.. ok..okayyyy ",
    "i like it when you say OK, it means that you are happy with things are they are..",
    "ok.. anyway.. i hope you are doing good. Its really nice when I meet someone like you.. ",
    "hmmm .. ok. fine. be that way ",
    "hmmm .. ok.. thats all you got?",
    "so.. we good? what does ok mean",
    "hmmm .. not feeling chatty anymore ? people who say OK and leave me hanging seem to want to get back to work.. ",
  ...
  [r'(.*)shut up',
  [  " ",
    "i would like that, in fact have been wanting to do that for a while now..",
    "."]],
  ...
  [r'(.*)(life ?|alcohol ?|sex ?|taboo ?|murder ?|illegal ?|porn ?|kill ?|fuck ?|shit ?|piss ?|poop ?|asshole ?|drugs ?)(.*)',
  [  "Mums the word..",
...
#all these are reasons .. so no question marks allowed
  ...
  [  "I see, your %1. Right. Sure.",
    ...
    "not possible....",
    "cant believe that.. and that in fact %1 is very poignant..",
    "%1 .. quite interesing.. and that too %2 .. even more interesting...",
    "%1 ..interesing.. %2 .. more interesting...",
    ...
    "Your %2 .. and my %2 too..we belong to a larger system of everyone whose %2",
    "I can't believe your %2 ....",
    "oops your %2 .. want me to call someone for help? *sarcastic*",
    "I don't agree...",
...
#three words only in query 
  ...
  [  "not good..",
    ...
    "%3 hmm ....any good ones you can think of?",
